...
const { get_parner_data, get_sub, change_password, history ,locate, get_partners, get_recomandation, get_recent_partners} = require("../controllers/Partner");
